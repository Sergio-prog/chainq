...
from chainq.commands import aave, aerodrome, ethena, hl, lido, lighter, llama, morpho, pendle, sky, uniswap

app = typer.Typer(
    no_args_is_help=True,
    help="Protocol integrations: Aave, Morpho, Hyperliquid, Lighter, Uniswap, Pendle, Sky, Ethena, Lido, Aerodrome, DefiLlama.",
)
